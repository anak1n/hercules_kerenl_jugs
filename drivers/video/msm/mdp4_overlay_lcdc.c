...
void mdp4_lcdc_overlay(struct msm_fb_data_type *mfd)
{
	...
	mutex_unlock(&mfd->dma->ov_mutex);
/* 
   Scenario : Youtube / Idle crash 
   Cause    : While suspend resume sequence  during resume the system is not able to exit the suspend state
   Change   : Giveup CPU after vssync commit
*/
